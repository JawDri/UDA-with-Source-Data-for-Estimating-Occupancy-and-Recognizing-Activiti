...
parser.add_argument("--pre_epoches", default=100, type=int)
...
import pandas as pd
import numpy as np
Source_train = pd.read_csv("/content/drive/MyDrive/HAFN/code/data/Source_train.csv")
Source_test = pd.read_csv("/content/drive/MyDrive/HAFN/code/data/Source_test.csv")
Target_train = pd.read_csv("/content/drive/MyDrive/HAFN/code/data/Target_train.csv")
Target_test = pd.read_csv("/content/drive/MyDrive/HAFN/code/data/Target_test.csv")
...
for epoch in range(1, args.pre_epoches + 1):
    for i, s_img in tqdm.tqdm(enumerate(source_loader)):
        #print(s_imgs)
        s_imgs = s_img['X']
        s_labels = s_img['Y']
